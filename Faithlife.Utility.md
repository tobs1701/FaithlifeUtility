...
| class [CachingStream](Faithlife.Utility/CachingStream.md) | A stream wrapper that caches all data read from the underlying Stream. |
...
| class [RebasedStream](Faithlife.Utility/RebasedStream.md) | [`RebasedStream`](Faithlife.Utility/RebasedStream.md) is a stream wrapper that changes the effective origin of the wrapped stream. |
...
| class [TruncatedStream](Faithlife.Utility/TruncatedStream.md) | [`TruncatedStream`](Faithlife.Utility/TruncatedStream.md) is a read-only stream wrapper that will not read past the specified length. |
